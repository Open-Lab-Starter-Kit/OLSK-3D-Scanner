...
import { Suspense, useState, useEffect, useRef, useContext, useMemo, Fragment, Component } from 'react'
...
export default function App() {
    ...
    const modelIn = useGLTF('./OLSK_3DScanner_V3_IN.glb') //Substitute the file name here for ALL IN
    const modelOut = useGLTF('./OLSK_3DScanner_V3_OUT.glb') //Substitute the file name here for ALL OUT
    ...
    useGLTF.clear('./OLSK_3DScanner_V3_IN.glb')  //Substitute the file name here for ALL IN
    useGLTF.clear('./OLSK_3DScanner_V3_OUT.glb') //Substitute the file name here for ALL OUT
 ...
 */}
                ...
                {/* <div className='viewAreaPlaceholder' id="viewAreaPlaceholder">
...
useGLTF.preload('./OLSK_3DScanner_V3_IN.glb') //Substitute the file name here for ALL IN
useGLTF.preload('./OLSK_3DScanner_V3_OUT.glb') //Substitute the file name here for ALL OUT
